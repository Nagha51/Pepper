...
ips = ["192.168.8.106", "192.168.8.105", "192.168.8.101", "192.168.8.104"]
...
class c_thr(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            self.AutonomousLife = ALProxy(
                "ALAutonomousLife", self.ip, self.port)
...
def main():
    ...
    thrds = allThreads[0: NB_BOTS]  # Beware: Last element not included
